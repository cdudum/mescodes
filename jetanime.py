...
SITE_IDENTIFIER = 'jetanime' #identifant (nom de votre fichier) remplacez les espaces et les . par _ AUCUN CARACTERE SPECIAL
SITE_NAME = 'jetanime.co' #nom que xbmc affiche
SITE_DESC = 'série animation' #description courte de votre source

URL_MAIN = 'https://www.jetanime.co/' #url de votre source
